...
public ResponseEntity<Map<String, Object>> handleInvalidCredentialException(
    ...
    public void handleClientAbort(Exception ex){
        log.debug("Cleint closed connection during streaming(expected for video seeking/buffering):{}",ex.getMessage());
    }
    ...
    private ResponseEntity<Map<String,Object>>buildResponse(HttpStatus status,String message){
        Map<String,Object>body=Map.of("timestap",Instant.now(),"error",message);
